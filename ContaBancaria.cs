...
namespace AgenciaBancaria.Dominio
{
    ...
    public abstract class ContaBancaria
    {
        ...
        private void SetaSenha(string senha)
        {
            ...
            //metodo !Regex.IsMatch valida com expressao regular
        ...
        // DateTime? colocando dessa forma estou permitindo que esse campo seja nulo ou nao
// dados que nao mudam (init)
